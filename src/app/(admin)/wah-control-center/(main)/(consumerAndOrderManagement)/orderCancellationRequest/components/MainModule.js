"use client"
import getOrdersWithCancellationRequest from '@/app/actions/getOrdersWithCancellationRequest'
import getSearchedOrdersProcessingAndAwbGenerated from '@/app/actions/getSearchedOrdersProcessingAndAwbGenerated'
...
const MainModule = ({ itemsPerPage ,pageNo}) => {
    ...
    const fetchResults = useCallback(
        debounce(async (searchQuery) => {
            ...
            try {
                setIsLoading(true)
                const response = await getOrdersWithCancellationRequest(searchQuery,itemsPerPage,pageNo)
