            ...
            <div className="row">
              <div className="col-md-6 col-lg-3">
                <div className="top-selling">
                  ...
                  {productsTopSelling.map((pro) => <TopSellingProduct goTo={`/product-details/${pro.slug}`} imageS={pro.thumbNail[0].url} discount={pro.varient[0].discount}  productName={pro.name} price={pro.varient[0].mrp} varientId={pro.varient[0].id} />)}
                </div>
              </div>
              ...
              <div className="col-md-6 col-lg-3">
                <div className="top-selling">
                  ...
                  {productsTrending.map((pro) => <TopSellingProduct goTo={`/product-details/${pro.slug}`} imageS={pro.thumbNail[0].url} discount={pro.varient[0].discount} productName={pro.name} price={pro.varient[0].mrp} varientId={pro.varient[0].id} />)}
              ...
              <div className="col-md-6 col-lg-3">
                <div className="top-selling">
                  ...
                  {productRecentlyAdded.map((pro) => <TopSellingProduct goTo={`/product-details/${pro.slug}`} imageS={pro.thumbNail[0].url} discount={pro.varient[0].discount}  productName={pro.name} price={pro.varient[0].mrp} />)}
                </div>
              ...
              <div className="col-md-6 col-lg-3">
                <div className="top-selling">
                  ...
                  {productTopRated.map((pro) => <TopSellingProduct goTo={`/product-details/${pro.slug}`} imageS={pro.thumbNail[0].url} discount={pro.varient[0].discount}  productName={pro.name} price={pro.varient[0].mrp} />)}
                </div>
              </div>
